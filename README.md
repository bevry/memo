...
``` typescript
import pkg from 'https://unpkg.com/@bevry/memo@^3.4.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/@bevry/memo/^3.4.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/@bevry/memo@^3.4.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/@bevry/memo@3.4.0'
</script>
```
